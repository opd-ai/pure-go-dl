...
const (
	...
	relocRelative  = R_AARCH64_RELATIVE
	reloc64        = R_AARCH64_ABS64
	relocGlobDat   = R_AARCH64_GLOB_DAT
	relocJumpSlot  = R_AARCH64_JUMP_SLOT
	relocCopy      = R_AARCH64_COPY
	reloc32        = R_AARCH64_ABS32
	reloc32S       = R_AARCH64_ABS32
	relocPC32      = R_AARCH64_PREL32
	relocPLT32     = R_AARCH64_PREL32
	relocDTPMod64  = R_AARCH64_TLS_DTPMOD64
	relocDTPOff64  = R_AARCH64_TLS_DTPREL64
	relocTPOff64   = R_AARCH64_TLS_TPREL64
	relocDTPOff32  = R_AARCH64_TLS_DTPREL64
	relocTPOff32   = R_AARCH64_TLS_TPREL64
	relocGOTTPOff  = R_AARCH64_TLSIE_LD64_GOTTPREL_LO12_NC
	relocTLSGD     = R_AARCH64_TLSGD_ADR_PAGE21
	relocTLSLD     = R_AARCH64_TLSLD_ADR_PAGE21
	relocIRelative = R_AARCH64_IRELATIVE
)
