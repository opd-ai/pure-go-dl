...
const (
	...
	reloc32S       = R_AARCH64_ABS16 // ARM64 doesn't have signed 32-bit; use 16-bit for distinct value
	relocPC32      = R_AARCH64_PREL32
	relocPLT32     = R_AARCH64_PREL16 // ARM64 doesn't distinguish PLT32; use PREL16 for distinct value
	relocDTPMod64  = R_AARCH64_TLS_DTPMOD64
	relocDTPOff64  = R_AARCH64_TLS_DTPREL64
	relocTPOff64   = R_AARCH64_TLS_TPREL64
	relocDTPOff32  = R_AARCH64_TLSLD_LDST32_DTPREL_LO12_NC // 32-bit variant for DTPREL
	relocTPOff32   = R_AARCH64_TLSLE_LDST32_TPREL_LO12_NC  // 32-bit variant for TPREL
